    ...
    <section id="services">
      <div className="container lg:pt-5">
        <div className="text-center">
          <h2 className="text-tectColor font-[800] text-[2.4rem] mb-5">
            What do I help?
          </h2>
            ...
            <div className="relative text-gray-700 antialiased text-sm font-semibold">
              ...
              <div className="mt-6 sm:mt-0 sm:mb-12">
                <div className="flex items-center flex-col sm:flex-row">
                  <div className="flex justify-start w-full mx-auto items-center">
                    <div className="w-full sm:w-1/2 sm:pr-8">
                      <div
                        ...
                        className="bg-white p-4 rounded shadow group hover:bg-accentColor cursor-pointer ease-in duration-150"
                      >
                  ...
                  <div className="rounded-full bg-accentColor border-white border-4 w-10 h-10 absolute left-1/2 transform -translate-x-1/2 -translate-y-4 sm:translate-y-0 flex items-center justify-center">
                    <figure>
